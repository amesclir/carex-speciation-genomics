# --- Circos Plot for Carex Boryana Genomic Density (5 Tracks) ---
...
# --- Configuration ---
DATA_FILE <- "carex_boryana_genomic_data.json"
...
pdf("carex_boryana_circos_plot_line.pdf", width = 9, height = 9)
...
cat("\nSUCCESS: 5-track Circos plot saved to carex_boryana_circos_plot_line.pdf (using lines for smoother visualization)\n")
