...
FILTERED_NUCLEOTIDE_DIR = "filtered_alignments_INSIDE"
FINAL_ORTHOLOG_LIST = "final_ortholog_list_INSIDE.txt"

# New output directory for the final, clean alignments (ready for PAML/HyPhy)
OUTPUT_DIR = "codon_aligned_dnds_INSIDE"

# Temporary directories for intermediate files
TEMP_PEP_ALIGN_DIR = "temp_pep_alignments_INSIDE" 
# ---------------------
