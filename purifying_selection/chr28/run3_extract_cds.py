...
if __name__ == "__main__":
    ...
    BORBONICA_LIST = "target_borbonica_genes_INSIDE.txt"
    BORYANA_LIST = "target_boryana_orthologs_INSIDE.txt"
    ...
    BORBONICA_FASTA_OUT = "borbonica_ortholog_cds_INSIDE.fasta"
    BORYANA_FASTA_OUT = "boryana_ortholog_cds_INSIDE.fasta"
