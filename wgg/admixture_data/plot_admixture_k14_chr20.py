...
q_file_path = "admixture_results/admixture_chr20_inversion_final_ld_pruned.14.Q" 
...
fam_file_path = "admixture_chr20_inversion_final_ld_pruned.fam" 

# Output file BASE NAME for the plot
output_plot_base = "admixture_plot_K14_chr20_final_aligned" 
...
# Cyan components are now fixed at K3, K6, K7, K9, and K11.
colors = [
    # K1 (Index 0): Orange
    '#BF360C',
    # K2 (Index 1): Orange
...
try:
    ...
    ax.set_title(f"ADMIXTURE Plot for K={NUM_K} (Chr20 Inversion Region - Final Aligned)", fontsize=16)
