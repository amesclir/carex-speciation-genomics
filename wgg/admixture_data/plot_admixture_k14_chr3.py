...
q_file_path = "admixture_results/admixture_chr3_inversion_final_ld_pruned.14.Q" 
...
fam_file_path = "admixture_chr3_inversion_final_ld_pruned.fam" 

# Output file BASE NAME for the plot
output_plot_base = "admixture_plot_K14_chr3_final_aligned" 
...
# Cyan components are now fixed at K1, K3, K5, K7, K9, and K10. The rest are Orange/Amber.
colors = [
    # K1 (Index 0): CYAN (NEWLY requested)
    '#4DD0E1',
    # K2 (Index 1): Orange
    '#E65100',
    # K3 (Index 2): CYAN (Requested)
    '#005C6B',
    # K4 (Index 3): Orange
    '#FB8C00',
    # K5 (Index 4): CYAN (Requested)
    '#00ACC1',
    # K6 (Index 5): ORANGE (NEWLY requested, was Cyan)
    '#FF7043',
    # K7 (Index 6): CYAN (Requested)
    '#78C2AD',
    # K8 (Index 7): Orange
    '#FFD54F',
    # K9 (Index 8): CYAN (Requested)
    '#A2D9CE',
    # K10 (Index 9): CYAN (Requested)
    '#3E8E7E',
    # K11 (Index 10): Orange
    '#BF360C',
    # K12 (Index 11): Orange
...
try:
    ...
    ax.set_title(f"ADMIXTURE Plot for K={NUM_K} (Chr3 Inversion Region - Final Aligned)", fontsize=16)
