...
output_plot_base = "admixture_subset_k8_k11_plot" # NEW BASE FILENAME for the subset plot
...
# --- DATASET CONFIGURATION LIST (Subsetted to K=8 and K=11) ---
PLOTS_CONFIG = [
    # 1. K=8 (Whole Dataset)
    {
...
def load_and_prepare_data(config):
    ...
    Includes validation checks for K and color count.
    """
    num_k = config['k']
