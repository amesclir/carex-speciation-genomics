...
q_file_path = "admixture_results/admixture_chr28_inversion_final_ld_pruned.2.Q"
...
output_plot_base = "admixture_chr28_inv_plot_K2"
...
try:
    ...
    print(f"ADMIXTURE plot for K=2 saved to {output_plot_base}.png")
    
    # Save as PDF (default DPI is usually high resolution for vector format)
    plt.savefig(f"{output_plot_base}.pdf")
    print(f"ADMIXTURE plot for K=2 saved to {output_plot_base}.pdf")
