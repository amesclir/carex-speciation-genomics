...
q_file_path = "admixture_results_cv/admixture_final_850k_pruned.8.Q"
...
output_plot_base = "admixture_plot_K8_K1K2K6_Cyan"
...
try:
    ...
    ax.set_title(f"ADMIXTURE Plot for K={NUM_K} (K1, K2, K6 Cyan; K3, K4, K5, K7, K8 Orange)", fontsize=16)
