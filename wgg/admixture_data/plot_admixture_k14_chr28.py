...
q_file_path = "admixture_results/admixture_chr28_inversion_final_ld_pruned.14.Q" 
...
fam_file_path = "admixture_chr28_inversion_final_ld_pruned.fam" 

# Output file BASE NAME for the plot
output_plot_base = "admixture_plot_K14_chr28_final_aligned" 
...
# Cyan/Teal components are now fixed at K1, K3, K6, K7, K9, and K10. The rest are Orange/Amber.
colors = [
    ...
    # K5 (Index 4): Orange
    '#FFB300',
    # K6 (Index 5): CYAN (NEWLY requested)
    '#00ACC1',
    # K7 (Index 6): CYAN 
    '#78C2AD',
    # K8 (Index 7): Orange
...
try:
    ...
    ax.set_title(f"ADMIXTURE Plot for K={NUM_K} (Chr28 Inversion Region - Final Aligned)", fontsize=16)
