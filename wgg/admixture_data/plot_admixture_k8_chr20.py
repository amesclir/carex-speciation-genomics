...
q_file_path = "admixture_results/admixture_chr20_inversion_final_ld_pruned.8.Q"
...
output_plot_base = "admixture_plot_K8_chr20"
...
# --- Cyan Tonalities (K6 - swapped from K3) ---
    '#FFD54F',  # K6: Light Cyan (Formerly K3's position)

    # --- Orange Tonalities (K5) ---
    '#FFB300',  # K5: Golden Orange
    
    # --- Orange Tonalities (K4) ---
    '#4DD0E1',  # K4: Light Amber/Yellow-Orange
...
try:
    ...
    ax.set_title(f"ADMIXTURE Plot for K={NUM_K} (K2, K6 Cyan; K1, K3, K4, K5, K7, K8 Orange)", fontsize=16)
