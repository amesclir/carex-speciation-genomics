...
# Updated file paths to use the new chromosome 3-specific files from the R script.
rda_scores_path = "rda_snp_scores_chr3.csv"
selected_snps_path = "selected_snps_for_plotting_chr3.csv"
...
# Output filenames
output_png = "multipanel_genomic_plot_chr3.png"
output_pdf = "multipanel_genomic_plot_chr3.pdf"
...
ax2.set_xlabel("Genomic Position (Chromosome 3)", fontsize=12)
