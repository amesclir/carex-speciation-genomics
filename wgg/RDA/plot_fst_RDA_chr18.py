...
# Updated file paths to use the new chromosome 18-specific files from the R script.
rda_scores_path = "rda_snp_scores_chr18.csv"
selected_snps_path = "selected_snps_for_plotting_chr18.csv"
...
# Output filenames
output_png = "multipanel_genomic_plot_chr18.png"
output_pdf = "multipanel_genomic_plot_chr18.pdf"
...
ax2.set_xlabel("Genomic Position (Chromosome 18)", fontsize=12)
