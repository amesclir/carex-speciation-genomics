...
# Updated file paths to use the new chromosome 28-specific files from the R script.
rda_scores_path = "rda_snp_scores_chr28.csv"
selected_snps_path = "selected_snps_for_plotting_chr28.csv"
...
# Output filenames
output_png = "multipanel_genomic_plot_chr28.png"
output_pdf = "multipanel_genomic_plot_chr28.pdf"
...
ax2.set_xlabel("Genomic Position (Chromosome 28)", fontsize=12)
