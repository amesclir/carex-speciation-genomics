...
rda_plot <- ggplot() +
  ...
  scale_color_manual(
    values = c("C_borbonica1"="cyan","C_borbonica2"="cyan3", "hybrid1"="cyan4", "C_boryana1"="lightgoldenrod1", "C_boryana2"="gold","C_boryana3"="orange","C_boryana4"="orange3","C_boryana5"="orange4", "hybrid2"="brown4"),
    labels = c("C_borbonica1"="borbonica PF", "C_borbonica2"="borbonica LM", "hybrid1"="borbonica int.", "C_boryana1"="boryana PF", "C_boryana2"="boryana TF", "C_boryana3"="boryana LM", "C_boryana4"="boryana PN", "C_boryana5"="boryana RE",  "hybrid2"="boryana int.")  
  ) +
  # --- CHANGE END ---
...
pdf("RDA_plot_pop_col.pdf", width = 8, height = 8)
print(rda_plot)
dev.off()

print("RDA plot saved as RDA_plot_pop_col.pdf")
...
pdf("PCA_plot_bioclim_col.pdf", width = 8, height = 8)
print(pca_plot)
dev.off()

print("PCA plot saved as PCA_plot_bioclim_col.pdf")
