...
output_plot_path = "fst_manhattan_plot_high_Fst_10k_rearrangementsINVDUPTRANSINVDPINVTR_with_enrichment.png"
...
print("\n--- Testing Top 30 Largest Rearrangements Individually ---")
top_30_rearrangements = df_rearrangements.sort_values('SIZE', ascending=False).head(30).copy()
