...
## Data Availability
Raw sequencing data and associated metadata have been deposited in the NCBI database under the following accessions:
* **BioProject ID:** `PRJNA1464375`
* **BioSample Accessions:** `SAMN59706852` – `SAMN59707043` (Includes samples for *Carex borbonica*, *Carex boryana*, *Carex laevigata*, and *Carex helodes*).
*(Note: Raw FASTQ reads are currently being processed and will be publicly available in the Sequence Read Archive (SRA) linked to this BioProject).*
...
* **Visualization**: Python/R scripts for final genome visualization.
...
* **`dsuite/`**: Scripts for calculating Patterson’s D and $f_d$ statistics to test for introgression across the genomic background and within focal inversions (ABBA-BABA).
